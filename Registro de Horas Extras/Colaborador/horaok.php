...
<head>
  ...
  <title>HE - Hora Cadastrada!</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php">HE</a>
    ...
    <div>
        <div class="alert alert-sucess">
            <div class="alert alert-sucess col-md-3"> 
                <div class="alert alert-info alert-dismissible" role="alert">Registrada!</div>
                <a href="horas_extras.php"><input type="submit" name="btn_l1" value="Todas as horas" class="btn btn-primary">
            </div>
        </div>
    </div>
        <div>
