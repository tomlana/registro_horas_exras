...
<body>
    ...
    <p>Insira seus dados para entrar</p>
      <div class="row">
        ...
        <div>
          <p>É administrador? Acesse a página de login, clicando no link abaixo</p>
          <a href="login_administrador.php"><button type="submit" name="btn_retorno1" class="btn btn-primary mb-3">Visitar</button></a>
        </div> 
        </div>
      </div>
